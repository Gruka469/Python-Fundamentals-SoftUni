...
def swap_lessons(lesson_one: str, lesson_two: str, list_arg: list) -> None:
    if lesson_one in list_arg and lesson_two in list_arg:
        ...
        list_arg[index_lesson_one], list_arg[index_lesson_two] = list_arg[index_lesson_two], list_arg[index_lesson_one]
...
for number, lesson in enumerate(soft_uni_lessons, start=1):
